# nomad-perovskite-solar-cell-sample-plains

An adaptation of the perovksite solar cell database schema for measurements and plains software
...
```sh
git clone https://github.com/Tor Vergata Unversity of Rome/nomad-perovskite-solar-cell-sample-plains.git
cd nomad-perovskite-solar-cell-sample-plains
